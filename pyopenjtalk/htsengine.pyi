...
class HTSEngine:
    ...
    def add_half_tone(self, half_tone: float = 0.0) -> None:
        ...
        pass
    def synthesize(
        self, labels: list[str | bytes | bytearray]
        ...
        """
        pass
    def synthesize_from_strings(self, labels: list[str | bytes | bytearray]) -> None:
        """Synthesize from strings"""
        pass
    def get_generated_speech(self) -> np.ndarray[tuple[int], np.dtype[np.float64]]:
